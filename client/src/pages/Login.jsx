...
import {
  Form, Input, Button, Typography, Card, Checkbox,
  Divider, Alert, Space, Row, Col,
} from "antd";
import {
  MailOutlined, LockOutlined, MedicineBoxOutlined,
...
const Login = () => {
  ...
  useEffect(() => {
    if (success && user) {
      ...
      const destination = from || ROLE_REDIRECTS[user.role] || "/dashboard";
      ...
      <Row style={{ width: "100%", maxWidth: 960 }} gutter={[32, 32]} align="middle">
        ...
        <Col xs={0} md={12}>
          <div style={{ padding: "0 24px" }}>
            ...
            <Title level={3} style={{ color: "#333" }}>Welcome Back</Title>
            <Paragraph style={{ color: "#666", fontSize: 16, lineHeight: 1.8 }}>
              Sign in to manage your appointments, view your health records, and connect with your doctors.
            </Paragraph>
            <div style={{
              background: "white", borderRadius: 16, padding: 24,
              boxShadow: "0 4px 16px rgba(0,0,0,0.06)", marginTop: 32,
            }}>
              <Text strong style={{ display: "block", marginBottom: 8 }}>🔒 Your data is safe with us</Text>
              <Text type="secondary" style={{ fontSize: 14, lineHeight: 1.7 }}>
                We use industry-standard encryption to protect your personal health information.
              </Text>
            </div>
          </div>
        </Col>
        ...
        <Col xs={24} md={12}>
          ...
          >
            ...
            >
              ...
              <Form.Item style={{ marginBottom: 4 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <Link to="#" style={{ fontSize: 13, color: "#1890ff" }}>
                    Forgot password?
                  </Link>
                </div>
              </Form.Item>
            ...
            <Divider style={{ margin: "16px 0" }}>
              <Text type="secondary" style={{ fontSize: 13 }}>New to Book a Doctor?</Text>
            </Divider>
